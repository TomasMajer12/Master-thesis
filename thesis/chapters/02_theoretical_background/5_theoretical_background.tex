...
backbone parameters together with the pairwise matrix. The abstract
$w$ of Section~\ref{sec:learning-mn} is used only inside the
derivations there; from Section~\ref{subsec:training-procedure}
onwards the parameters are referenced as $(\theta, W)$ explicitly.
