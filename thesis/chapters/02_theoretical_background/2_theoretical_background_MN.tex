...
the compatibility of the labels at neighboring nodes. Equation
...
structure: given the labels of its neighbors, $y_v$ is conditionally
...
has $20$ such neighbors ($8$ in its row, $8$ in its column, and $4$
