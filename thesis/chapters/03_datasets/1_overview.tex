...
\emph{tractable testbed}: the LP relaxation is exact on trees, so on
chains the LP-relaxed M\textsuperscript{3}N learning loss must
coincide with exact structured-hinge training, providing an
end-to-end correctness check for the LP-M3N implementation
