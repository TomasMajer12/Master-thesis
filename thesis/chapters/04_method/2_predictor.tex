...
Section~\ref{subsec:backbone-interface} is realized through the
...
should penalize equal-label configurations $W_{a, a}$.
Initialization is Gaussian with standard deviation
